  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold text-center mb-12">Maintenance Services</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">Our certified technicians provide professional maintenance for all types of appliances.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">Round-the-clock customer support for emergency maintenance needs.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">Same-day service for urgent maintenance requests.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground">All maintenance work comes with our satisfaction guarantee.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a href="https://wa.me/1234567890" className="text-green-500 hover:underline">WhatsApp</a>
          </div>
        </div>
      </main>
